        ...
        <>
            <li className="mb-4">
                <div className="flex grow">
                    <input type="text" className="px-4 py-3 text-sm w-full rounded-s ring-1 ring-text-light bg-primary-light focus:ring-2 focus:bg-primary-light/90 focus:ring-accent-dark outline-none hover:ring-accent hover:ring-2 text-text transition-all duration-100" placeholder="Book's name" onChange={handleInputChange} />
