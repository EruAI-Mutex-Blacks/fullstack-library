...
namespace fullstack_library.Migrations
{
    ...
    [Migration("20240824131315_removeAuthorIdPublishReqTAble")]
    partial class removeAuthorIdPublishReqTAble
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LibraryApp.Data.Entity.Book", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsBorrowed = false,
                            IsPublished = true,
                            PublishDate = new DateTime(2024, 4, 16, 13, 13, 15, 694, DateTimeKind.Utc).AddTicks(7887),
                            Title = "Book 1"
                        },
                        new
                        {
                            ...
                            IsBorrowed = false,
                            IsPublished = true,
                            PublishDate = new DateTime(2024, 8, 11, 13, 13, 15, 694, DateTimeKind.Utc).AddTicks(7893),
                            Title = "Book 2"
                        },
                        new
                        {
                            ...
                            IsBorrowed = false,
                            IsPublished = true,
                            PublishDate = new DateTime(2024, 3, 18, 13, 13, 15, 694, DateTimeKind.Utc).AddTicks(7895),
                            Title = "Book 3"
                        });
                });
            ...
            modelBuilder.Entity("LibraryApp.Data.Entity.BookBorrowActivity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            BookId = 1,
                            BorrowDate = new DateTime(2024, 8, 17, 13, 13, 15, 694, DateTimeKind.Utc).AddTicks(7981),
                            IsApproved = false,
                            IsReturned = false,
                            ReturnDate = new DateTime(2024, 8, 23, 13, 13, 15, 694, DateTimeKind.Utc).AddTicks(7982),
                            UserId = 1
                        },
                        new
                        {
                            Id = 2,
                            BookId = 2,
                            BorrowDate = new DateTime(2024, 8, 10, 13, 13, 15, 694, DateTimeKind.Utc).AddTicks(7983),
                            IsApproved = false,
                            IsReturned = false,
                            ReturnDate = new DateTime(2024, 8, 17, 13, 13, 15, 694, DateTimeKind.Utc).AddTicks(7984),
                            UserId = 2
                        },
                        new
                        {
                            Id = 3,
                            BookId = 3,
                            BorrowDate = new DateTime(2024, 8, 3, 13, 13, 15, 694, DateTimeKind.Utc).AddTicks(7985),
                            IsApproved = false,
                            IsReturned = false,
                            ReturnDate = new DateTime(2024, 8, 10, 13, 13, 15, 694, DateTimeKind.Utc).AddTicks(7985),
                            UserId = 3
                        });
                });
            ...
            modelBuilder.Entity("LibraryApp.Data.Entity.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            BirthDate = new DateTime(1993, 8, 3, 13, 13, 15, 694, DateTimeKind.Utc).AddTicks(8080),
                            FineAmount = 0f,
                            Gender = 'M',
                            IsPunished = false,
                            Name = "User 1",
                        ...
                        {
                            Id = 2,
                            BirthDate = new DateTime(1985, 5, 20, 13, 13, 15, 694, DateTimeKind.Utc).AddTicks(8083),
                            FineAmount = 0f,
                            Gender = 'W',
                            IsPunished = false,
                            Name = "User 2",
                        ...
                        {
                            Id = 3,
                            BirthDate = new DateTime(1984, 6, 30, 13, 13, 15, 694, DateTimeKind.Utc).AddTicks(8085),
                            FineAmount = 0f,
                            Gender = 'W',
                            IsPunished = false,
                            Name = "User 3",
            ...
            modelBuilder.Entity("LibraryApp.Data.Entity.BookPublishRequest", b =>
                {
                    ...
                    b.HasOne("LibraryApp.Data.Entity.User", null)
                        .WithMany("BookPublishRequests")
                        .HasForeignKey("UserId");
